...
from cyclops.processors.column_names import AGE, DIAGNOSIS_TRAJECTORY, DIAGNOSIS_CODE, READMISSION, HOSPITAL_ID, SEX
from cyclops.processors.constants import TARGETS
from cyclops.utils.file import join, process_dir_save_path

CONST_NAME = "mortality_allDx"
...
EXCLUDE = [HOSPITAL_ID, DIAGNOSIS_TRAJECTORY,DIAGNOSIS_CODE, 'los_derived']
TAB_FEATURES = [
    HOSPITAL_ID,
    AGE,
    SEX, 
